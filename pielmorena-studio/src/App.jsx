...
function App() {
  ...
  const correoInvalido = intentoLogin && (!correo.trim() || !validarCorreo(correo))
  const passwordInvalido = intentoLogin && (!password.trim() || !passwordFuerte)
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`${inputBase} ${correoInvalido ? inputError : inputNormal}`}
                  />

                  {intentoLogin && !correo.trim() && (
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`${inputBase} pr-12 ${passwordInvalido ? inputError : inputNormal}`}
                    />
                    ...
                    >
                      {mostrarPassword ? (
                        ...
                        >
                          ...
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9.88 4.24A9.77 9.77 0 0112 4c5.5 0 9 5 9 8a7.18 7.18 0 01-1.67 3.94" />
                          <path strokeLinecap="round" strokeLinejoin="round" d="M6.11 6.11C4.17 7.47 3 9.68 3 12c0 3 3.5 8 9 8a9.77 9.77 0 004.01-.85" />
                        </svg>
                      ) : (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  {password && (
                    <div className="mt-3 rounded-2xl border border-white/10 bg-white/5 p-3">
                      ...
                      <div className="grid gap-1 text-xs">
                        <p className={passwordRules.minimo ? 'text-[#d4af37]' : intentoLogin ? 'text-red-300' : 'text-white/45'}>
                          {passwordRules.minimo ? '✓' : '•'} Mínimo 8 caracteres
                        </p>

                        <p className={passwordRules.mayuscula ? 'text-[#d4af37]' : intentoLogin ? 'text-red-300' : 'text-white/45'}>
                          {passwordRules.mayuscula ? '✓' : '•'} Una letra mayúscula
                        </p>

                        <p className={passwordRules.minuscula ? 'text-[#d4af37]' : intentoLogin ? 'text-red-300' : 'text-white/45'}>
                          {passwordRules.minuscula ? '✓' : '•'} Una letra minúscula
                        </p>

                        <p className={passwordRules.numero ? 'text-[#d4af37]' : intentoLogin ? 'text-red-300' : 'text-white/45'}>
                          {passwordRules.numero ? '✓' : '•'} Un número
                        </p>

                        <p className={passwordRules.simbolo ? 'text-[#d4af37]' : intentoLogin ? 'text-red-300' : 'text-white/45'}>
                ...
                <button className="w-full rounded-2xl bg-[#d4af37] px-6 py-3.5 font-bold text-black shadow-lg shadow-[#d4af37]/20 transition hover:-translate-y-0.5 hover:bg-white">
                  Ingresar al sistema
                </button>
              </div>
            </form>
